package com.nscharrenberg.elect.amazon.gateways.messaging;

import com.nscharrenberg.elect.amazon.gateways.application.QueueName;
...
public class MessageConnectionGateway {
    ...
    /**
     * Initialize the connection with the amazon.
     */
    private void initConnection() {
        ...
        props.put(String.format("queue.%s_%s", QueueName.OFFER_JOB_REQUEST, "amazon"), String.format("%s_%s", QueueName.OFFER_JOB_REQUEST, "amazon"));
