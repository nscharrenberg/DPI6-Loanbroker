...
import com.nscharrenberg.elect.microsoft.gateways.application.QueueName;
...
public class MessageConnectionGateway {
    ...
    /**
     * Initialize the connection with the microsoft.
     */
    private void initConnection() {
        ...
        props.put(String.format("queue.%s_%s", QueueName.OFFER_JOB_REQUEST, "microsoft"), String.format("%s_%s", QueueName.OFFER_JOB_REQUEST, "microsoft"));
