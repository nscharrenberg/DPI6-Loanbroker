package com.nscharrenberg.elect.sodexo.gateways.messaging;

import com.nscharrenberg.elect.sodexo.gateways.application.QueueName;
...
public class MessageConnectionGateway {
    ...
    /**
     * Initialize the connection with the sodexo.
     */
    private void initConnection() {
        ...
        props.put(String.format("queue.%s_%s", QueueName.OFFER_JOB_REQUEST, "sodexo"), String.format("%s_%s", QueueName.OFFER_JOB_REQUEST, "sodexo"));
