...
import ing.bank.gateways.application.BankApplicationGateway;
import model.bank.*;
...
public class JMSBankFrame extends JFrame {
	...
	public JMSBankFrame() {
		...
		btnSendReply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rr!= null && reply != null){
					rr.setReply(reply);
                    list.repaint();
                    bankApplicationGateway.sendInterestReply(rr);
				}
			}
		});
		...
		bankApplicationGateway = new BankApplicationGateway() {
            @Override
            public void OnInterestRequestArrived(BankInterestRequest bankInterestRequest) {
